...
const ProfileInfo = ({ userData }) => {
  ...
  const onCropComplete = useCallback((_, croppedAreaPixels) => {
    console.log("Crop Area Pixels (From Cropper):", croppedAreaPixels);
  ...
  const handleConfirmCrop = async () => {
    try {
      ...
      console.log("Crop Image Source:", cropImageSrc);
      ...
      setProfileImageUrl(croppedUrl); // Set as profile picture
        ...
        <div className="crop-modal">
          <div className="crop-container">
            <Cropper
              ...
              showGrid={false}
              cropShape="rect"
              aspect={2 / 3} // Adjust aspect ratio as needed
